...
class FlipLoader extends StatefulWidget {
  ...
  FlipLoader({ this.iconColor = Colors.white,this.path, this.animationType = "full_flip", this.shape = "square", this.rotateIcon = true});


  @override
  _FlipLoaderState createState() => _FlipLoaderState( this.iconColor, this.path, this.animationType, this.shape, this.rotateIcon);
}
...
class _FlipLoaderState extends State<FlipLoader>
  ...
  _FlipLoaderState( this.iconColor, this.path, this.animationType, this.shape, this.rotateIcon);
          ...
          child: new Transform(
            ...
            child: Container(
                ...
                child: rotateIcon == true ? new RotationTransition(
                  ...
                  child: new Center(
                    child:ImageIcon(new AssetImage(path,),size: 70,color: iconColor,)
                  ),
                ) : Center(
                  child: ImageIcon(new AssetImage(path,),size: 70,color: iconColor,)
                )
        ...
        return Container(
          child: new Transform(
            ...
            child: Container(
              ...
              child: new Center(
                child: ImageIcon(
                  new AssetImage(path,), color: iconColor, size: 90.0,
                ),
              ),
            ),
          ),
